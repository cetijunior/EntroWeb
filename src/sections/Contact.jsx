...
export default function Contact() {
    ...
    return (
        <section
            id="contact"
            className="relative min-h-screen flex items-center justify-center px-4 py-20 bg-gradient-to-br from-slate-50 via-white to-blue-50 overflow-hidden"
            itemScope
        ...
        >
            ...
            <div className="relative z-10 max-w-5xl w-full space-y-16">
                ...
                <div className="text-center space-y-6">
                    ...
                    <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 leading-tight" itemProp="headline">
                        {t("headline.prefix")}
                    ...
                    <p className="text-xl text-gray-600 leading-relaxed max-w-2xl mx-auto" itemProp="description">
                        {t("description")}
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
                    <div className="flex items-start space-x-4 p-4 bg-white/60 backdrop-blur-sm rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
                        ...
                        <div>
                            <p className="text-sm font-medium text-gray-900">{t("email.title")}</p>
                            <a href="mailto:hello@waves.com" className="text-indigo-600 hover:text-indigo-700 transition-colors" itemProp="email">
                                hello@waves.com
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4 p-4 bg-white/60 backdrop-blur-sm rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
                        ...
                        <div>
                            <p className="text-sm font-medium text-gray-900">{t("phone.title")}</p>
                            <a href="tel:+1234567890" className="text-green-600 hover:text-green-700 transition-colors" itemProp="telephone">
                                +1 (234) 567-890
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4 p-4 bg-white/60 backdrop-blur-sm rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
                        ...
                        <div>
                            <p className="text-sm font-medium text-gray-900">{t("location.title")}</p>
