                    ...
                    >
                        ...
                        <div className="relative z-10 h-full flex flex-col justify-between text-white">
                            <div className="p-6 space-y-6 overflow-y-auto">
                                {/* Header */}
                                <div className="flex justify-between items-center mb-2 bg-white/10 backdrop-blur-lg p-2 rounded-xl border border-white/20">
                                    <h2 className="w-full text-lg text-center font-semibold">Pages</h2>
                                </div>
                                    ...
                                    {mainLinks.map((link) => (
                                        <div key={link.path}>
                                            <button
                                                ...
                                                className={`block w-full text-left hover:text-indigo-300 font-medium transition ${location.pathname === link.path
